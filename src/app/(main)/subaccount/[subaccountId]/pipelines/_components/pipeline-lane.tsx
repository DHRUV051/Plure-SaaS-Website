      ...
      {(provided, snapshot) => {
        ...
        return (
          ...
          >
            <AlertDialog>
              <DropdownMenu>
                <div className="bg-slate-200/30 dark:bg-background/20  h-[700px] w-[300px] px-4 relative rounded-lg overflow-auto scrollbar flex-shrink-0 ">
                  <div
                  ...
                  >
                    {(provided) => (
                      <div className=" max-h-[700px] overflow-auto scrollbar pt-12 ">
                        <div
